...
import {
  DailyTrendCard,
  type Dimension,
} from "../../components/stats/DailyTrendCard";
...
export default function StatsScreen() {
  ...
  const { data: filtered = [] } = useMonthlyTransactions(
    year,
    month,
    selectedAccountId,
  );
  ...
  const { data: prevFiltered = [] } = useMonthlyTransactions(
    prevYear,
    prevMonth,
    selectedAccountId,
  );
  ...
  const daysElapsed = useMemo(
    () => computeDaysElapsed(currentDate),
    [currentDate],
  );
