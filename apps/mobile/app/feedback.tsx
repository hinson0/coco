    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.section}>
          <AppText size="lg" weight="semibold" color={colors.text} style={styles.label}>反馈类型</AppText>
            ...
            {FEEDBACK_TYPES.map((type) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.tag,
                    { backgroundColor: selected ? colors.sage : colors.creamDark },
                  ]}
                >
                  <AppText
                    size="md"
        ...
        {/* 问题描述 */}
        <View style={styles.section}>
          <AppText size="lg" weight="semibold" color={colors.text} style={styles.label}>问题描述</AppText>
          <View>
            <TextInput
            ...
            />
            <AppText size="sm" color={colors.textLighter} style={styles.charCount}>
        ...
        {/* 联系方式 */}
        <View style={styles.section}>
          <AppText size="lg" weight="semibold" color={colors.text} style={styles.label}>联系方式（选填）</AppText>
          <TextInput
            style={styles.input}
            placeholder="邮箱或微信号"
            placeholderTextColor={colors.textLighter}
      ...
      <View style={[
        styles.bottomBar,
        { paddingBottom: keyboardHeight > 0 ? keyboardHeight : insets.bottom + 20 },
      ]}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <AppText size="xl" weight="bold" color={colors.white}>提交反馈</AppText>
        </TouchableOpacity>
      </View>
    </View>
  );
