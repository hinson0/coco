...
describe("getDimensionValue", () => {
  ...
  it("returns expense", () =>
    expect(getDimensionValue(day, "expense")).toBe(100));
  it("returns income", () =>
    expect(getDimensionValue(day, "income")).toBe(200));
  it("returns balance (income - expense)", () =>
    expect(getDimensionValue(day, "balance")).toBe(100));
  it("returns negative balance", () => {
    expect(
      getDimensionValue({ date: "", expense: 300, income: 100 }, "balance"),
    ).toBe(-200);
  });
});
